...
<html lang="{{ $Lingua }}">
  <head>
    ...
    <title>{{ __('checkin.meta.TITLE') }}</title>
    <meta name="keywords" content="{{ __('checkin.meta.KEY') }}" />
    <meta name="description" content="{{ __('checkin.meta.DESC') }}" /> 
    ...
    <div class="smart-wrap">
        ...
        <? if($tot_cs > 0){?>
                ...
                <?=ucfirst($Nome)?> <?=ucfirst($Cognome)?><br>                     
                    <div style="padding-left:50px">{{ __('checkin.titoli.TITOLO4') }} {{$Nprenotazione}}<br>{{ __('checkin.titoli.STRILLO4') }}</div>
                </h4>
        ...
        <?}else{?>
                <h4><i class="fa fa-pencil-square"></i>
                    <?=ucfirst($Nome)?> <?=ucfirst($Cognome)?><br>                    
                    <div style="padding-left:50px">{{ __('checkin.titoli.TITOLO') }}<br>{{ __('checkin.titoli.STRILLO') }}<br>                     
               ...
               <div class="form-body">                     
                  <div class="spacer-b30">
                        <div class="tagline">
                          <span>
                          @if(!$NumeroPersone)
                            {{ __('checkin.etichette.STEP')}} 1 {{ __('checkin.etichette.DI')}} 1
                          @else
                            {{ __('checkin.etichette.STEP')}} 1 {{ __('checkin.etichette.DI')}} {{$NumeroPersone}}
                          @endif
                        </span>
                      </div>{{-- .tagline --}}
                    </div>                             
                    <form id="checkin_form" class="form-horizontal" role="form" method="post" action="/insertCheckin" enctype="multipart/form-data" >     
                      <div class="frm-row">                    
                       <div class="section colm colm6">                                                                                       
                                    <label class="field select">
                                        <select data-toggle="tooltip" data-trigger="hover" data-placement="top" title="{{ __('checkin.etichette.TOOLTIP_COMPONENTI') }}" id="foo" tabindex="1"   name="TipoComponente" id="TipoComponente" >
                            ...
                            <div class="section colm colm6">
                                <label class="field">
                                    <span id="helpBlock" class="help-block"><?=nl2br( __('checkin.etichette.TXT_HELP2') )?></span>
                                </label>
                            </div>{{-- end section --}}                    
                ...
                <div class="CF" style="display: none;">                  
                    <div class="frm-row">{{-- apertura riga --}}                                 
                          <div class="section colm colm6">{{-- apertura colonna--}}                                   
                                <label for="TipoDocumento" class="field select">
                                  <select  name="TipoDocumento" id="TipoDocumento" tabindex="2">
                    ...
                    <div class="section colm colm12 text-center">
                      <em>
                        <small>
                         <i class="fa fa-legal"></i> Attenzione chi dichiara e sottoscrive informazioni false durante la compilazione del modulo di Checkin Online, commette un vero e proprio reato, duramente sanzionato dal nostro ordinamento giuridico!</div>
                        </small>
                      </em>
                    </div>                                  
        ...
        <div class="spacer-t20 spacer-b30">
            ...
            <div class="frm-row">{{-- apertura riga --}}         
              <div class="section colm colm6">{{-- apertura colonna --}}
                    <label for="Nome" class="field prepend-icon">
                      <input type="text" class="gui-input" placeholder="{{ __('checkin.anagrafica.NOME') }}" name="Nome" id="Nome" tabindex="8">                    
                            <label for="names" class="field-icon"><i class="fa fa-user"></i></label>  
                    </label>
                </div>    {{-- chiusura colonna --}} 
                <div class="section colm colm6">{{-- apertura colonna --}} 
                    <label for="Cognome" class="field prepend-icon">
                      <input type="text" class="gui-input" placeholder="{{ __('checkin.anagrafica.COGNOME') }}" name="Cognome" tabindex="9">
            ...
            <div class="frm-row">{{-- apertura riga --}}         
             ...
             <div class="frm-row">{{-- apertura riga --}}         
              <div class="section colm colm6">{{-- apertura colonna --}}
                    ...
                    <label for="Regione" class="field select">
                  ...
                  <div class="cit_bis"  style="display: none;">
                       <label for="Citta" class="field prepend-icon">
                        <input class="gui-input" id="CittaBis" name="CittaBis" type="text" placeholder="{{ __('checkin.anagrafica.CITTA') }}" tabindex="14" >
                        <label for="city" class="field-icon"><i class="fa fa-map-marker"></i></label>
                        </label>
                   </div> 
                </div>    {{-- chiusura colonna --}} 
                <div class="section colm colm6">{{-- apertura colonna --}} 
                    ...
                    <div class="prov_bis"  style="display: none;">
                        ...
                        <input type="text" class="gui-input" placeholder="{{ __('checkin.anagrafica.PROVINCIA') }}" name="ProvinciaBis" tabindex="13">
                        </label>
                    </div>  
                 </div> {{-- chiusura colonna --}}   
              </div>  {{-- chiusura riga --}}                    
            ...
            <div class="frm-row">{{-- apertura riga --}}         
              <div class="section colm colm6">{{-- apertura colonna --}}
                     <label for="Indirizzo" class="field prepend-icon">
                      <input type="text" class="gui-input" placeholder="{{ __('checkin.anagrafica.INDIRIZZO') }}" name="Indirizzo" tabindex="14">
              ...
              <div class="section colm colm6">{{-- apertura colonna --}}
                  <div class="cp">  
                    <label for="Cap" class="field prepend-icon">           
                       <input type="text" class="gui-input" placeholder="{{ __('checkin.anagrafica.CAP') }}" name="Cap" tabindex="16" maxlength="5">
            ...
            <?php 
                for($n=2; $n<=$NumeroPersone; $n++){               
                   if($n > 1) echo '<div class="spacer-t20 spacer-b30">
                                        <div class="tagline"><span>'.$n.'° '. __('checkin.altro.COMPONENTE') .'</span></div>{{-- .tagline --}}
                                    </div>';                   
              ?>
               <div class="frm-row">{{-- apertura riga --}}         
                  <div class="section colm colm6">{{-- apertura colonna a sinistra--}}
                        <label for="Name[]" class="field prepend-icon">
                          <input placeholder="{{ __('checkin.anagrafica.NOME') }}" type="text" class="gui-input"  name="Name[]">
                          <label for="names" class="field-icon"><i class="fa fa-user"></i></label>  
                        </label>                                                                
                  </div> {{-- chiusura colonna a sinistra--}}            
                   <div class="section colm colm6">{{-- apertura colonna a destra--}}
                        <label for="Surname[]" class="field prepend-icon">
                          <input placeholder="{{ __('checkin.anagrafica.COGNOME') }}" type="text" class="gui-input"  name="Surname[]">
                          <label for="names" class="field-icon"><i class="fa fa-user"></i></label>  
                        </label>                                           
                  ...
                  <div class="section colm colm6">{{-- apertura colonna a sinistra--}}
                      <?php if($NumeroPersone > 1){ ?>                                                                      
                       ...
                       <?php }else{ ?>
                         ...
                         <div id="clear"></div> 
                          <input name="policy_soggiorno" id="policy_soggiorno" type="radio" value="1"  required><br> <?php echo __('checkin.privacy.ACCONSENTI_PRIVACY_POLICY_SOGGIORNO') ?>
                                  <div id="politiche_soggiorno" style="display:none" class="text-justify">
                                        <small>
                                        <br>
