...
## TEMPLATE CUSTOM 1 ##
Route::get('/custom1/{directory}/{params}/index', [Custom1Controller::class, 'custom1_template'])->where([
    'directory' => '[a-zA-Z0-9._-]+', // Accetta lettere, numeri, underscore, punti e trattini
    'params'    => '[a-zA-Z0-9=+/]+' // Pattern per "id_richiesta_idsito_tipo"
]);
...
## TEMPLATE CUSTOM 2 ##
Route::middleware(['settaSessione', 'dizionario'])
->get('/custom2/{directory}/{params}/index', [Custom2Controller::class, 'custom2_template'])->where([
    'directory' => '[a-zA-Z0-9._-]+', // Accetta lettere, numeri, underscore, punti e trattini
    'params'    => '[a-zA-Z0-9=+/]+' // Pattern per "id_richiesta_idsito_tipo"
]);
...
## TEMPLATE CUSTOM 3 ##
Route::middleware(['settaSessione', 'dizionario'])
->get('/custom3/{directory}/{params}/index', [Custom3Controller::class, 'custom3_template'])->where([
    'directory' => '[a-zA-Z0-9._-]+', // Accetta lettere, numeri, underscore, punti e trattini
    'params'    => '[a-zA-Z0-9=+/]+' // Pattern per "id_richiesta_idsito_tipo"
]); 
...
## TEMPLATE CUSTOM 4 ##
Route::middleware(['settaSessione', 'dizionario'])
->get('/custom4/{directory}/{params}/index', [Custom4Controller::class, 'custom4_template'])->where([
    'directory' => '[a-zA-Z0-9._-]+', // Accetta lettere, numeri, underscore, punti e trattini
    'params'    => '[a-zA-Z0-9=+/]+' // Pattern per "id_richiesta_idsito_tipo"
]);
...
## TEMPLATE CUSTOM 5 ##
Route::middleware(['settaSessione', 'dizionario'])
->get('/custom5/{directory}/{params}/index', [Custom5Controller::class, 'custom5_template'])->where([
    'directory' => '[a-zA-Z0-9._-]+', // Accetta lettere, numeri, underscore, punti e trattini
    'params'    => '[a-zA-Z0-9=+/]+' // Pattern per "id_richiesta_idsito_tipo"
]);
...
## TEMPLATE CUSTOM 6 ##
Route::middleware(['settaSessione', 'dizionario'])
->get('/custom6/{directory}/{params}/index', [Custom6Controller::class, 'custom6_template'])->where([
    'directory' => '[a-zA-Z0-9._-]+', // Accetta lettere, numeri, underscore, punti e trattini
    'params'    => '[a-zA-Z0-9=+/]+' // Pattern per "id_richiesta_idsito_tipo"
]); 
...
## TEMPLATE CUSTOM 7 ##
Route::middleware(['settaSessione', 'dizionario'])
->get('/custom7/{directory}/{params}/index', [Custom7Controller::class, 'custom7_template'])->where([
    'directory' => '[a-zA-Z0-9._-]+', // Accetta lettere, numeri, underscore, punti e trattini
    'params'    => '[a-zA-Z0-9=+/]+' // Pattern per "id_richiesta_idsito_tipo"
]);
...
## TEMPLATE CUSTOM 8 ##
Route::middleware(['settaSessione', 'dizionario'])
->get('/custom8/{directory}/{params}/index', [Custom8Controller::class, 'custom8_template'])->where([
    'directory' => '[a-zA-Z0-9._-]+', // Accetta lettere, numeri, underscore, punti e trattini
    'params'    => '[a-zA-Z0-9=+/]+' // Pattern per "id_richiesta_idsito_tipo"
]);
...
## TEMPLATE CUSTOM 9 ##
Route::middleware(['settaSessione', 'dizionario'])
->get('/custom9/{directory}/{params}/index', [Custom9Controller::class, 'custom9_template'])->where([
    'directory' => '[a-zA-Z0-9._-]+', // Accetta lettere, numeri, underscore, punti e trattini
    'params'    => '[a-zA-Z0-9=+/]+' // Pattern per "id_richiesta_idsito_tipo"
]); 
...
## CHECKIN TEMPLATE ##
Route::middleware(['settaSessione', 'dizionario'])
->get('/checkin/{directory}/{params}/index', [CheckinController::class, 'checkin_online'])->where([
    'directory' => '[a-zA-Z0-9._-]+', // Accetta lettere, numeri, underscore, punti e trattini
    'params'    => '[a-zA-Z0-9=+/]+' // Pattern per "id_richiesta_idsito_tipo"
]);
