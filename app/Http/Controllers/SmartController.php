...
class SmartController extends Controller
{
    ...
    public function get_carosello($idsito)
    {
        $carosello = '';
        $slide = '';
        $sel_carosello  = "SELECT * FROM hospitality_gallery WHERE Abilitato = :Abilitato AND idsito = :idsito ORDER BY rand() LIMIT 12";
        $q_carosello  = DB::select($sel_carosello,['idsito' => $idsito, 'Abilitato' => 1]);
