...
class Custom3Controller extends Controller
{
    ...
    public function get_carosello($idsito)
    {
        ...
        $res  = DB::select($sel,['TargetType' => 'custom3', 'idsito' => $idsito]);
        if(sizeof($res )>0){
                $IdGallery = $res[0]->Id;
    ...
    public function custom3_template($directory, $params, Request $request)
    {
        $template = 'custom3';
        ...
        $res_color = DB::select($sel_color,['idsito' => $idsito, 'TemplateType' => 'custom3']);
        $rCol      = $res_color[0];
        ...
        return view('custom3_template/index',
            [
                'directory'             => $directory,
                'id_richiesta'          => $id_richiesta,
                'idsito'                => $idsito,
    ...
    public function questionario($directory, $params, Request $request)
    {
        ...
        $tot_quest = sizeof($res_quest);
            ...
            return view('custom3_template/questionario',
                                                            [
