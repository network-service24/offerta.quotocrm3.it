...
class Custom2Controller extends Controller
{
    ...
    public function get_carosello($idsito)
    {
        ...
        $res  = DB::select($sel,['TargetType' => 'custom2', 'idsito' => $idsito]);
        if(sizeof($res )>0){
                $IdGallery = $res[0]->Id;
    ...
    public function custom2_template($directory, $params, Request $request)
    {
        $template = 'custom2';
        ...
        $res_color = DB::select($sel_color,['idsito' => $idsito, 'TemplateType' => 'custom2']);
        $rCol      = $res_color[0];
        ...
        return view('custom2_template/index',
            [
                'directory'             => $directory,
                'id_richiesta'          => $id_richiesta,
                'idsito'                => $idsito,
    ...
    public function questionario($directory, $params, Request $request)
    {
        ...
        $tot_quest = sizeof($res_quest);
            ...
            return view('custom2_template/questionario',
                                                            [
