...
require_once($_SERVER['DOCUMENT_ROOT']."/IGFS_CG_API/init/BaseIgfsCgInit.php");
require_once($_SERVER['DOCUMENT_ROOT']."/IGFS_CG_API/Level3Info.php");
require_once($_SERVER['DOCUMENT_ROOT']."/IGFS_CG_API/MandateInfo.php");
