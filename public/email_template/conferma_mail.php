                                                                                                                               ...
                                                                                                                               <tbody>
                                                                                                                                  <tr style="vertical-align: top">
                                                                                                                                     <td align="left" style="word-break: break-word;border-collapse: collapse !important;vertical-align: top;width: 90%;padding-top: 0px;padding-right: 30px;padding-bottom: 0px;padding-left: 5px">
                                                                                                                                        <div align="left" style="width:215px" width="215"><b>'.($logo!=''?'<img src="'.config('global.settings.BASE_URL_IMG').'uploads/loghi_siti/'.$logo.'" alt="'.$NomeHotel.'" class="center fullwidth" align="left" border="0" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block;border: 0;height: auto;line-height: 100%;margin: 0 auto;float: none;width: 215px;max-width: 215px" width="215" data-bee="true">':ucfirst($NomeHotel)).'</b></div>
                                                                                                                                     </td>
                                                                                                                                  </tr>
                                                                                                                               </tbody>
                                                                                                                            </table>
